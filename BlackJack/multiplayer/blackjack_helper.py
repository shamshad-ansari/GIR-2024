...
# Return:
#   none
def print_end_game_status(player_name, user_hand, dealer_hand, player_score):

  if user_hand > 21:
    player_score -=1
    print(f'{player_name} loses! Score: {player_score}')
    return player_score
  elif dealer_hand > 21:
    player_score +=1
    print(f'{player_name} wins! Score: {player_score}')
    return player_score
    ...
    print(f'{player_name} pushes. Score: {player_score}')
    return player_score
